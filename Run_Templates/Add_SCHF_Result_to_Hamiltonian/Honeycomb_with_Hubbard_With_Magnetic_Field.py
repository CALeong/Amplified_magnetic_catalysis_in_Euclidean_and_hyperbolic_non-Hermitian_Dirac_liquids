...
from Fundamental.Hubbard import add_onsite_hubbard_repulsion_hartree_decomposition_honeycomb
...
hamiltonian_with_schf_result = add_onsite_hubbard_repulsion_hartree_decomposition_honeycomb(nval, hamiltonian,
